...
- **Required CRD versions**: Gateway API v1.5+ (GatewayClass, Gateway, HTTPRoute, GRPCRoute, etc.)
- **Installation**: `kubectl apply --server-side --force-conflicts -f https://github.com/kubernetes-sigs/gateway-api/releases/download/v1.5.0/standard-install.yaml`
